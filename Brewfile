# Dotfiles Brewfile
# Generated from current system - run `brew bundle` to install all packages
# To update: `brew bundle dump --file=~/.dotfiles/Brewfile --force`
...
# ============================================================================
# Language-specific packages (installed via brew)
# ============================================================================
