...
description: Apply software architecture patterns (layered, hexagonal, clean, event-driven). Use when designing systems, refactoring structure, or choosing architecture.
