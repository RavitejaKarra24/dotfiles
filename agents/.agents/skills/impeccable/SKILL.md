---
name: impeccable
description: Design, redesign, polish, or critique frontend UI (landing pages, dashboards, product UI, forms, empty states). Use for visual hierarchy, UX review, anti-AI-slop polish, and interface quality.
version: 3.9.1
---
